...
const testimonials = [
  ...
  {
    quote: "As an engineer in the sustainability sector, the insights from the keynote sessions were immediately applicable. The certificate and Crossref DOI gave my abstract real academic weight.",
    name: "S. Kowalski",
