...
const faqs = [
  ...
  },
  {
    ...
    a: "All topics related to engineering, technology, sustainability, AI, green energy, smart systems, climate tech, advanced materials, and related interdisciplinary fields.",
  },
];
