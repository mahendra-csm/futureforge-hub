    ...
    <section className="section-padding gradient-section relative" ref={ref}>
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          {/* Certificate image — using blur.png from assets */}
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.3 }}
            ...
            <p className="text-gray-500 leading-relaxed text-sm">
              Recognized & Indexed Event Documentation — each certificate carries the conference identity, participant details, and unique Certificate ID with accreditation badges.
            </p>
